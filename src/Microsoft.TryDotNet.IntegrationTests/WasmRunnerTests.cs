...
public class WasmRunnerTests : PlaywrightTestBase
{
    ...
    [Fact]
    public async Task can_run_asembly()
    {
        using var process = new AspNetProcess();
        var url = await process.Start();
