...
<head>
    <meta http-equiv=""Content-Type"" content=""text/html;charset=utf-8"">
    <link rel=""stylesheet"" href=""/css/trydotnet.css?v={_cacheBuster}"">
    <title>dotnet try - {_startupOptions.DirectoryAccessor.GetFullyQualifiedRoot().FullName.HtmlEncode()}</title>
</head>
...
<header>
    <div>
        ...
        <span class=""project-file-path"">{_startupOptions.DirectoryAccessor.GetFullyQualifiedRoot().FullName.ToLowerInvariant().HtmlEncode()}</span>
    </div>
