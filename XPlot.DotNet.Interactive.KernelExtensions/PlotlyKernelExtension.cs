...
{
    public class PlotlyKernelExtension : IKernelExtension
    {
...
var renderPlotly = function() {
    var xplotRequire = requirejs.config({context:'xplot-plotly-2.0.0',paths:{plotly:'https://cdn.plot.ly/plotly-1.49.2.min'}});
